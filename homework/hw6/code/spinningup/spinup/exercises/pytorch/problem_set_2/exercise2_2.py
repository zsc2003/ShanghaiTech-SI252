...
class BuggedMLPQFunction(nn.Module):
    ...
    def forward(self, obs, act):
        ...
        q_squeezed = torch. squeeze(q, -1)
        # print(q.shape) ([64, 1])
        # print(q_squeezed.shape) ([64])
...
if __name__ == '__main__':
    ...
    # batchsize_1
    eg = ExperimentGrid(name='ex2-2_ddpg_batchsize_1')
    ...
    eg.add('epochs', int(args.total_steps * 64 / args.steps_per_epoch))
